...
# Function to handle button clicks and display the text entry
def button_click(char):
    global calc_operator
    calc_operator += str(char)
    text_input.set(calc_operator)

# Function to clear all of the input text
...
# Function to display the factorial of a number (caluclation is done in the definition above)
def fact_func():
    global calc_operator
...
# Tkinter library functionalities to create the GUI of the calculator
tk_calc = Tk()
tk_calc.configure(bg="#040404", bd=10)
...
button_params = {'bd':5, 'fg':'#C1FE03', 'bg':'#3C3636', 'font':('sans-serif', 20, 'bold')}
button_params_main = {'bd':5, 'fg':'#C1FE03', 'bg':'#BBB', 'font':('sans-serif', 20, 'bold')}
